...
Silakan login lalu ganti password. Terima kasih.</textarea>
            ...
            @php
                $canManageDocs = $user->can('uploadDocument', $staff);
            @endphp

            <x-ui.card title="Dokumen" subtitle="Pendataan dokumen pendukung TAS">
                <x-ui.table>
                    <x-slot:head>
                        <tr>
                    ...
                    @forelse($staff->documents as $doc)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap">
                                @if ($fileUrl)
                                    <a href="{{ route('staff.documents.show', [$staff, $doc]) }}" target="_blank"
                                ...
                                @if ($canManageDocs)
                                    ...
                                    <a href="{{ route('staff.documents.edit', [$staff, $doc]) }}"
                                    ...
                                    <span class="text-gray-300 mx-2">|</span>
                                    <form method="POST"
                                        action="{{ route('staff.documents.destroy', [$staff, $doc]) }}"
                                        class="inline"
                ...
                @if ($canManageDocs)
                    <div id="dokumen-upload" class="mt-6 border border-gray-200 rounded-xl bg-gray-50 p-6">
                        ...
                        <form method="POST" action="{{ route('staff.documents.store', $staff) }}"
