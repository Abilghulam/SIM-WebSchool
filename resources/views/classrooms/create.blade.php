<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="text-xl font-semibold text-gray-900 leading-tight">Tambah Kelas</h2>
                <p class="text-sm text-gray-500 mt-1">Buat data kelas baru.</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="{{ route('classrooms.store') }}" class="space-y-6">
                ...
                <x-ui.card title="Data Kelas" subtitle="Isi jurusan, tingkat, dan nama kelas.">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <x-ui.select name="grade_level" label="Tingkat (opsional)" :error="$errors->first('grade_level')">
                            <option value="">- Pilih -</option>
                            <option value="10" @selected(old('grade_level') == '10')>10</option>
                            <option value="11" @selected(old('grade_level') == '11')>11</option>
                            <option value="12" @selected(old('grade_level') == '12')>12</option>
                        </x-ui.select>
